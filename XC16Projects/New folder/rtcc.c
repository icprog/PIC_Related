...
//        LCDWriteIntXY(0,9,time.weekday,2);
        ...
        if(sel*3 == 0)
        {
            LCDWriteStringXY(1,sel*3+1,"^^");                                     // Draw Pointer, to show what we are setting
//            LCDWriteStringXY(1,sel*3,"^^");                                     // Draw Pointer, to show what we are setting
        }
