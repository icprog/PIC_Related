...
#pragma config BSS      =   BSS_OFF     // Boot Segment Code-Protect Level bits->No Protection (other than BWRP)
#pragma config BSEN     =   OFF     // Boot Segment Control bit->No Boot Segment
#pragma config GWRP     =   OFF     // General Segment Write-Protect bit->General Segment may be written
#pragma config GSS      =   GSS_OFF     // General Segment Code-Protect Level bits->No Protection (other than GWRP)
#pragma config CWRP     =   OFF     // Configuration Segment Write-Protect bit->Configuration Segment may be written
#pragma config CSS      =   CSS_DIS     // Configuration Segment Code-Protect Level bits->No Protection (other than CWRP)
#pragma config AIVTDIS  =   AIVTDIS_DISABLE // Alternate Interrupt Vector Table bit->Disabled AIVT
...
// FICD
//#pragma config ICS = PG1    // ICD Communication Channel Select bits->Communicate on PGEC1 and PGED1
