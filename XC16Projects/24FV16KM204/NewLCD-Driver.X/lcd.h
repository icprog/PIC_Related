...
#define LCD_RS_POS      4   //RS is connected to Port C bit 4

#define LCD_RW_PORT     C   //Read/Write (RW)
#define LCD_RW_POS      5   //RW is connected to Port C bit 5

#define LCD_E_PORT      C   //Enable signal (E)
#define LCD_E_POS       6   //E is connected to Port C bit 6
...
#define _CONCAT3(port,pos)  _R##port##pos
