...
#define xPos_In             TRISAbits.TRISA2        // pin 1 on connector
#define xNeg_In             TRISAbits.TRISA9        // pin 2 on connector
#define yPos_In             TRISAbits.TRISA3        // pin 3 on connector
...
// ***************************************************************************************************************************************************************
    ...
    unsigned char lastKeyState = KEY_NONE, key = KEY_NONE, j, k = 50, m = 50;
