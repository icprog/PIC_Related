...
void RTCC_Initialize(void) {
    ...
    RCFGCALbits.CAL7 = 0;                      // Enable RTCC Calibration
    ...
    RCFGCALbits.CAL1 = 1;                      // Enable RTCC Calibration
    RCFGCALbits.CAL0 = 1;                      // Enable RTCC Calibration
...
bool SetTime()
{
    ...
    unsigned char timer = 0;                 // Used to return to operation if user does not finish setting time! (MAX SETTING 254!!)
