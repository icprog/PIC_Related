 ...
 * Author: psychoul
 *
 * Created on September 5, 2011, 3:56 PM
 */
...
// define the pins
#define SCE_5110  LATCbits.LATC2
#define RESET_5110 LATCbits.LATC1
#define DC_5110 LATCbits.LATC0
...
rom char font[] = {0x00, 0x00, 0x00, 0x00, 0x00, // 20 space
...
void main(void)
{
    ...
    LCD5110_send(0x80, 0); //X address
    LCD5110_sendstring("Hello World!");

    LCD5110_send(0x40 + 1, 0); //Y address
    LCD5110_send(0x80, 0); //X address
    LCD5110_sendstring("5110 driven by");

    LCD5110_send(0x40 + 2, 0); //Y address
    LCD5110_send(0x80, 0); //X address
    LCD5110_sendstring("PIC18F4520 SPI");

    LCD5110_send(0x40 + 3, 0); //Y address
    LCD5110_send(0x80, 0); //X address
    LCD5110_sendstring("psychoul.com");
