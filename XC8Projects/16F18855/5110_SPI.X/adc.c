...
#define     numChannels                     1                                               // Number of Analog channels to read

uint16_t samples[numChannels][numSamples]   =   {0};                                  // Was left initialized like this, but following is correct?

uint16_t sampleIndex                        =   {0};

int32_t totals[numChannels]                 =   {0};

static int channels[numChannels]            =   {POT};                                      // List all the Analog channel numbers here, must be same number listed as numChannels
