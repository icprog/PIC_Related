...
#define LCD_CLK TRISCbits.TRISC5
#define LCD_DIN TRISCbits.TRISC4
#define LCD_DC TRISCbits.TRISC3
#define LCD_CE  TRISCbits.TRISC6
#define LCD_RST TRISCbits.TRISC7
...
//unsigned char ASCII[][5] = {
  ...
  ,{0x02, 0x04, 0x08, 0x10, 0x20} // 5c \ (backlash)
...
__delay_ms(1);  
  ...
  LCDWrite(LCD_COMMAND, 0x0D); //Set display control, normal mode. 0x0D for inverse
}
